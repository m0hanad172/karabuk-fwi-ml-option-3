...
\begin{enumerate}
  ...
  \texttt{best.pt} as the active detection model.
...
interpretation. Chapter 6 concludes the thesis and describes future work. The
appendix provides supplementary visual evidence that supports the main
chapters without overloading the core report.
