...
\texttt{best.pt} as the active fire/smoke detection model. This detector was
...
fire/smoke validation set. The uploaded YOLOv8 evaluation output provides
initial object-detection metrics, but a larger local benchmark and field
validation campaign are still needed before operational reliability can be
claimed.
