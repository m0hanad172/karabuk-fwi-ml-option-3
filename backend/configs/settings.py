...
DRONE_MODE = os.getenv("DRONE_MODE", "tello").strip().lower()
...
DRONE_ALLOW_MANUAL_CONTROL = _env_bool("DRONE_ALLOW_MANUAL_CONTROL", True)
DRONE_ALLOW_AUTO_TAKEOFF = _env_bool("DRONE_ALLOW_AUTO_TAKEOFF", True)
DRONE_ALLOW_DEMO_PATROL = _env_bool("DRONE_ALLOW_DEMO_PATROL", True)
...
DRONE_DEMO_UP_CM = _env_int("DRONE_DEMO_UP_CM", 20)
DRONE_DEMO_HOVER_SECONDS = _env_float("DRONE_DEMO_HOVER_SECONDS", 15.0)
DRONE_DEMO_COMMAND_DELAY_SECONDS = _env_float(
    "DRONE_DEMO_COMMAND_DELAY_SECONDS", 1.0
)
DRONE_KEYBOARD_CONTROL_SPEED = _env_int("DRONE_KEYBOARD_CONTROL_SPEED", 20)
DRONE_KEYBOARD_PULSE_SECONDS = _env_float("DRONE_KEYBOARD_PULSE_SECONDS", 0.2)
